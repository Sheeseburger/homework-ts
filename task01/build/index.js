...
function createPostDiv(post) {
    ...
    footer.textContent = "Post id: ".concat(post.id, ". User id: ").concat(post.userId);
    divElement.appendChild(title);
    divElement.appendChild(body);
    divElement.appendChild(footer);
    return divElement;
}
function renderAllPosts(posts, destination) {
    if (destination === void 0) { destination = "divForPosts"; }
